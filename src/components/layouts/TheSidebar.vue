...
<template>
  ...
  <aside
    class="fixed inset-y-0 left-0 z-50 transition-all duration-300 ease-in-out overflow-y-auto sm:relative"
    :class="[
      ui.mobileSidebarOpen ? 'translate-x-0 w-64 shadow-2xl' : '-translate-x-full sm:translate-x-0',
      ui.sidebarOpen ? 'sm:w-64' : 'sm:w-20',
      ui.theme === 'light'
  ...
  >
    ...
    <Transition name="slide-left">
      <div
        ...
        :class="ui.theme === 'light' ? 'bg-white text-gray-800' : 'bg-gray-900 text-gray-200'"
      >
        <!-- 🔶 LOGO 區 -->
        <div
          class="flex justify-center items-center border-b transition-all duration-300"
          :class="[
            ui.sidebarOpen ? 'py-3' : 'py-2',
            ui.theme === 'light' ? 'bg-white border-gray-200' : 'bg-gray-900 border-gray-700',
          ]"
        >
          <!-- 展開時：完整版 Logo -->
          <router-link
          ...
          <ul class="flex flex-col">
            ...
            <router-link v-slot="{ isExactActive, href, navigate }" to="/" custom>
              ...
              >
                ...
                >
                  ...
                  <span v-show="isSidebarFullyOpen">Dashboard</span>
                  <!-- Tooltip -->
                  <span
                    v-if="!ui.sidebarOpen"
            ...
            <li>
              <Disclosure v-slot="{ open }" :default-open="ui.expandedMenus.includes('users')">
                ...
                >
                  ...
                  <span v-show="isSidebarFullyOpen">User Management</span>
                  <span v-show="isSidebarFullyOpen" class="ml-auto">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5"
                ...
                <DisclosurePanel v-show="isSidebarFullyOpen">
                  <ul>
                    <!-- 👤 Users -->
                    <li>
                      <Disclosure v-slot="{ open }" :default-open="ui.expandedMenus.includes('user-sub')">
                        ...
                        >
                          ...
                          <span v-show="isSidebarFullyOpen">Users</span>
                          <span v-show="isSidebarFullyOpen" class="ml-auto">
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              class="h-5 w-5"
                          ...
                          <ul>
                            <router-link v-slot="{ isExactActive, href, navigate }" to="/users" custom>
                              ...
                              >
                                ...
                                >
                                  ...
                                  <span v-show="isSidebarFullyOpen">User List</span>
                                </a>
                              </li>
                            </router-link>
                            ...
                            <li class="pl-12" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
                              <a href="#" class="py-3 flex items-center">
                                ...
                                <span v-show="isSidebarFullyOpen">User Detail</span>
                              </a>
                            </li>
                          </ul>
                        </DisclosurePanel>
                    ...
                    <li class="px-8" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
                      <a href="#" class="py-3 flex items-center">
                        ...
                        <span v-show="isSidebarFullyOpen">Roles</span>
                      </a>
                    </li>
                    ...
                    <li class="px-8" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
                      <a href="#" class="py-3 flex items-center">
                        ...
                        <span v-show="isSidebarFullyOpen">Permissions</span>
                      </a>
                    </li>
                  </ul>
                </DisclosurePanel>
            ...
            <li class="px-4" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
              <a href="#" class="py-3 flex items-center">
                ...
                <span v-show="isSidebarFullyOpen">Reports</span>
              </a>
            </li>
            ...
            <li class="px-4" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
              <a href="#" class="py-2 flex items-center">
                ...
                <span v-show="isSidebarFullyOpen">Messages</span>
                <span
                  v-show="isSidebarFullyOpen"
            ...
            <li class="px-4" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
              <a href="#" class="py-2 flex items-center">
                ...
                <span v-show="isSidebarFullyOpen">Calendar</span>
              </a>
            </li>
            ...
            <li class="px-4" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
              <router-link :to="{ name: 'card' }" class="py-2 flex items-center">
                ...
                <span v-show="isSidebarFullyOpen">Card</span>
              </router-link>
            </li>
            ...
            <li class="px-4" :class="ui.theme === 'light' ? 'hover:bg-gray-100' : 'hover:bg-gray-700'">
              <router-link :to="{ name: 'login' }" class="py-2 flex items-center">
                ...
                <span v-show="isSidebarFullyOpen">Login</span>
              </router-link>
            </li>
          </ul>
        </nav>
